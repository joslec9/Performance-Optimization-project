...
var resizePizzas = function(size) {
  ...
  /** Replace querySelector with getElementById for performance boost according to
  ...
  **/
  ...
  function changePizzaSizes(size) {
    ...
    // Select all the pizza containers

    /** Replace querySelector with getElementsByClassName for performance boost according to
        https://jsperf.com/getelementsbyclassname-vs-queryselectorall/18

        Additionally, create a var to hold the length look-up val so the for loop doesn't force the browswer
        to look it up each time through.
    **/
...
/** Select the randomPizzas elements first then batch append them within the loop
**/
...
function updatePositions() {
  ...
  /** Set the following variables for elements to be looked up one time and stored for
      continual use rather than forcing the browser to re-gather the information each time
      it needs it to perform a calculation.

      Additionally, look up elements with getElByClassName instead of querySelector.
      See: https://jsperf.com/getelementsbyclassname-vs-queryselectorall/18
  **/
  ...
  **/
  ...
  for (var i = 0; i < cachedLength; i++) {
    ...
    /**
        Reposition pizzas using transform: translateX.
    **/
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  **/
  ...
  /**
      Create the var elem outside of the for loop to prevent its continued creation each time through the loop.
  **/
  var elem;
  ...
  for (var i = 0; i < pizzasNeeded; i++) {
    ...
    /**
        ...
        Addtionally, use getElementById rather than querySelector to boost performance.
    **/
